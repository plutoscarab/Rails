...
namespace Rails
{
	...
	public class Strategy
	{
		...
		public static Strategy[] CreateCombos(int contract1, int source1, int contract2, int source2)
		{
			ArrayList combos = new ArrayList();
			Strategy s;

			if (contract2 < Player.NumContracts - 2)
			{
				s = new Strategy();
			...
			if (contract1 < Player.NumContracts - 2)
			{
				s = new Strategy();
				s.AddStep(contract1, source1);
				s.AddStep(contract2, source2);
