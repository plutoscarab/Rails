...
namespace Rails
{
	public sealed class Images
	{
		...
		public static Bitmap Logo;				// train logo
		public static Bitmap GelButton1;
		public static Bitmap GelButton2;
		public static Bitmap GelButton3;
		...
		static Images()
		{
			...
			TrackBitmap = new Bitmap[6,3];
			BridgeBitmap = new Bitmap[6,3];
			for (int i=0; i<6; i++)
				for (int j=0; j<3; j++)
				{
			...
			Logo = (Bitmap) GetImage("Rails.Trains.Logo.jpg");
			GelButton1 = (Bitmap) GetImage("Rails.GelButton1.png");
			GelButton2 = (Bitmap) GetImage("Rails.GelButton2.png");
			GelButton3 = (Bitmap) GetImage("Rails.GelButton3.png");
		}
		...
		{
			Image image;
			if (resourceName.ToLower().EndsWith(".jpg"))
			{
