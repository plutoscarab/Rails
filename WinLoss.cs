	...
	public class WinLoss : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			System.Windows.Forms.ListViewItem listViewItem1 = new System.Windows.Forms.ListViewItem(new System.Windows.Forms.ListViewItem.ListViewSubItem[] {
																																								...
																																								new System.Windows.Forms.ListViewItem.ListViewSubItem(null, "987439843")}, -1);
			...
			this.tabControl1.Size = new System.Drawing.Size(521, 288);
			...
			this.tabPage1.Size = new System.Drawing.Size(513, 259);
			...
			this.listView1.Size = new System.Drawing.Size(513, 259);
			...
			this.tabPage2.Size = new System.Drawing.Size(513, 259);
			...
			this.listView2.Size = new System.Drawing.Size(513, 259);
			...
			this.tabPage3.Size = new System.Drawing.Size(513, 259);
		...
		void ApplyFilters()
		{
			...
			foreach (string name in snames)
			{
				...
				if (sheet.Wins + sheet.Losses > 0)
					items[4] = ((int)(100 * sheet.Wins / (sheet.Wins + sheet.Losses))).ToString() + "%";
				else
					items[4] = "?";
				if (sheet.TurnGames > 0)
					items[5] = ((int)(sheet.Turns / sheet.TurnGames)).ToString();
				else
					items[5] = "?";
