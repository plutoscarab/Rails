...
/* CONSTANTS ---------------------------------------------------------------------------------------- */
		...
		public static readonly StaticColorArray TrackColor = new StaticColorArray(new Color[] {Color.Green, Color.Crimson, Color.DodgerBlue, Color.MediumOrchid, Color.FromArgb(255, 177, 0), Color.DarkGray, Color.Black});
...
/* EVENT HANDLERS ------------------------------------------------------------------------------------ */
		...
		public void MouseDown(MouseEventArgs e)
		{
			...
			if (inUpgradeRect)
			{
				...
				// all is well
				state.ThisPlayer.Spend(Engine.UpgradeCost);
				state.AccumCost += Engine.UpgradeCost;
...
/* TURN MANAGEMENT ----------------------------------------------------------------------------------- */
		...
		bool PlayerMeetsRequirements(int i)
		{
			...
			return PlayerMeetsCityRequirements(i);
		}
...
cleanup:
		...
		public void ComputerMove()
		{
			...
			if (strategy == null || strategy.Steps.Count == 0)
			{
				...
				// so dump all of them
				if (strategy == null || strategy.Steps.Count == 0 || (strategy.PayoffRate < 0 && state.Turn > 2))
				{
					pl.Strategy = null;
