...
namespace Rails
{
	...
	public class MapGallery : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// serialNo
			// 
			this.serialNo.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right);
			this.serialNo.Location = new System.Drawing.Point(120, 173);
			this.serialNo.Name = "serialNo";
			this.serialNo.Size = new System.Drawing.Size(400, 16);
		...
		private void MapGallery_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				foreach (string filename in Directory.GetFiles(".\\maps", "*.rlm"))
				{
					...
					types.Add(typeof(AuthoredMap));
					int width = 128;
					if (width > maxWidth) maxWidth = width;
					int height = 105;
					if (height > maxHeight) maxHeight = height;
				}
				foreach (string filename in Directory.GetFiles(".\\maps", "*.ter"))
				{
					string s = Path.GetFileNameWithoutExtension(filename);
					seeds.Add(s);
		...
		private void panel1_Click(object sender, System.EventArgs e)
		{
			...
			if (selected != -1)
			{
				...
				else if (mapType == typeof(RandomMap))
				{
