...
namespace Rails
{
	...
	public class NewGame : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = Resource.GetString("Forms.Cancel");
			// 
			// groupBox3
			// 
			...
			this.groupBox3.Text = Resource.GetString("NewGame.Map");
			// 
			// seedOption
			// 
			...
			this.seedOption.Text = Resource.GetString("NewGame.SerialNumber");
			...
			this.galleryOption.Text = Resource.GetString("NewGame.SavedMap");
			...
			this.reuseOption.Text = Resource.GetString("NewGame.CurrentMap");
			...
			this.randomOption.Text = Resource.GetString("NewGame.RandomMap");
			...
			this.groupBox4.Size = new System.Drawing.Size(184, 156);
			this.groupBox4.TabIndex = 61;
			this.groupBox4.TabStop = false;
			this.groupBox4.Text = Resource.GetString("NewGame.Variations");
			// 
			// firstToCityBonus
			// 
			...
			this.firstToCityBonus.Text = Resource.GetString("NewGame.FirstToCity");
			// 
			// automaticTrack
			// 
			...
			this.automaticTrack.Text = Resource.GetString("NewGame.AutomaticTrack");
			...
			this.limitedCommodities.Text = Resource.GetString("NewGame.LimitedCommodities");
			// 
			// cityIncentives
			// 
			...
			this.cityIncentives.Text = Resource.GetString("NewGame.CityIncentives");
			// 
			// fastStart
			// 
			...
			this.fastStart.Text = Resource.GetString("NewGame.FastStart");
			// 
			// groupBox1
			// 
			...
			this.groupBox1.Text = Resource.GetString("NewGame.Players");
			// 
			// textBox6
			// 
			...
			this.textBox6.Text = Resource.GetString("NewGame.NotPlaying");
			...
			this.none5.Tag = "n5";
			this.none5.Text = Resource.GetString("NewGame.None");
			...
			this.textBox5.Text = Resource.GetString("NewGame.NotPlaying");
			...
			this.none4.Tag = "n4";
			this.none4.Text = Resource.GetString("NewGame.None");
			...
			this.textBox4.Text = Resource.GetString("NewGame.NotPlaying");
			...
			this.none3.Tag = "n3";
			this.none3.Text = Resource.GetString("NewGame.None");
			...
			this.textBox3.Text = Resource.GetString("NewGame.NotPlaying");
			...
			this.none2.Tag = "n2";
			this.none2.Text = Resource.GetString("NewGame.None");
			...
			this.textBox2.Text = Resource.GetString("NewGame.NotPlaying");
			...
			this.none1.Tag = "n1";
			this.none1.Text = Resource.GetString("NewGame.None");
			...
			this.textBox1.Text = Resource.GetString("NewGame.NotPlaying");
			...
			this.none0.Tag = "n0";
			this.none0.Text = Resource.GetString("NewGame.None");
			...
			this.Text = Resource.GetString("NewGame.Title");
