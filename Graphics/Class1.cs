...
namespace GraphicsGen
{
	...
	class Class1
	{
		static Color[] trackColor = {Color.Green, Color.Crimson, Color.DodgerBlue, Color.MediumOrchid, Color.FromArgb(255, 177, 0), Color.DarkGray, Color.Black};
